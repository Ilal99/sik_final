                    ...
                    <div class="container" style="height: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="top: 50%; transform:translate(0, -50%); position: absolute;">
                            <div class="well">
                                ...
                                <h4 align="center" style="margin: 15px 0 -10px 0; color: blue;"><b>SISTEM INFORMASI</br>STATUS KELULUSAN SISWA</b></h4>
                                <hr>
                                <script>
                                    function cekNo() {
                                    ...
                                    <form class="form-horizontal" form name="formcarino" method="post" action="carinisn" onSubmit="return cekNo()">
                                        <fieldset id="xpengumuman">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="nisn" placeholder="NIS" size="auto">
                                            </div>
                                            <div class="form-group" style="margin-bottom: -10px;">
                                                <p align="center"><b><input type="SUBMIT" name="SUBMIT" id="SUBMIT" value="CEK DATA" class="btn btn-primary"></b></p>
                                            </div>
                                        </fieldset>
                                    </form>
